...
if($exist){
    ...
    $sql= "INSERT INTO `veicoli` (`id`, `company`, `tipologia`, `marca`, `modello`, `targa`, `acquisto`, `assegnazione`, `stato`, `proprieta`, `km`, `tagliando`, `distribuzione`, `kml`, `bollo`, `assicurazione`, `revisione`, `vendita`, `note`, `posti`) 
